...
// Route resource untuk employees (otomatis mencakup semua method CRUD)
Route::resource('employees', EmployeeController::class)->middleware('auth');

// Route untuk mengambil data employees untuk DataTables
Route::get('getEmployees', [EmployeeController::class, 'getData'])->name('employees.getData');

// Route untuk export data employees ke Excel
Route::get('exportExcel', [EmployeeController::class, 'exportExcel'])->name('employees.exportExcel');

// Route untuk export data employees ke PDF
